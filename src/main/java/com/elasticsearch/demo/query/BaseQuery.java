...
public interface BaseQuery {
    ...
    public SearchHits queryAll(String indexName, String typeName) throws IOException ;
    ...
    public SearchHits idsQuery(String indexName, String typeName, String... ids) throws IOException ;
